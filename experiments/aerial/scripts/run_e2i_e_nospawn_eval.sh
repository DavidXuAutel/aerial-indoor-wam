...
# Uses E4 ckpt; Scene must stay 224. No FT.
set -euo pipefail
...
# Ensure indoor Scene stays 224×224
python3 - <<'PY'
import json
...
if changed:
    ...
    print("[e4b] settings Scene forced 224×224")
else:
    print("[e4b] settings Scene already 224×224")
PY
